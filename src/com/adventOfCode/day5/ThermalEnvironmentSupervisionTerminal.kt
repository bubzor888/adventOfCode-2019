...
fun main(args: Array<String>) {
    ...
    for (i in 1..15) {
        ...
        when {
            i < 8 -> println("Test3.$i: Result $testResult : ${testResult == 999}")
            i == 8 -> println("Test3.$i: Result $testResult : ${testResult == 1000}")
            else -> println("Test3.$i: Result $testResult : ${testResult == 1001}")
        }
    }
